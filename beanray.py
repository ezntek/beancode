...
def _color(arr: BCValue) -> p.Color:
    ...
    return p.Color(color[0].get_integer(), color[1].get_integer(), color[2].get_integer(), color[3].get_integer())
...
def _rectangle(rect: BCValue) -> p.Rectangle:
    ...
    return p.Rectangle(rec[0].get_integer(), rec[1].get_integer(), rec[2].get_integer(), rec[3].get_integer())
...
_COLOR_T = BCArrayType("integer", False, flat_bounds=(Literal("integer", 1), Literal("integer", 4)))
_RECT_T = BCArrayType("integer", False, flat_bounds=(Literal("integer", 1), Literal("integer", 4)))
...
procs = [
    BCProcedure("InitWindow", {"width": "integer", "height": "integer", "title": "string"}, init_window),
    ...
    BCProcedure("DrawRectangle", {"x": "integer", "y": "integer", "width": "integer", "height": "integer", "color": _COLOR_T}, draw_rectangle),
    BCProcedure("DrawRectangleRec", {"rect": _RECT_T, "color": _COLOR_T}, draw_rectangle_rec),
    BCProcedure("DrawText", {"text": "string", "x": "integer", "y": "integer", "size": "integer", "color": _COLOR_T}, draw_text)
]
