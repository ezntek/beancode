...
def real_main():
    ...
    parser.add_argument(
        "--tracer-open", action="store_true", help="open files generated by the tracer automatically."
    )
    parser.add_argument(
        "-O", "--optimize", action="store_true", help="optimize the AST before running (can be slow)."
    )
    parser.add_argument(
        "-i",
        "--stdin",
